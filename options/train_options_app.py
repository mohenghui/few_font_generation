...
class TrainOptionsApp(BaseOptionsApp):
    """This class includes training options.
    It also includes shared options defined in BaseOptions.
    """
# python train.py --dataroot ./datasets/test_font --model font_translator_gan --name test_new_dataset --no_dropout  --n_epochs 5 --n_epochs_decay 5 --continue_train
#首先test里面的数据copy到train的文件夹里，然后将权重移动复制到test_new_dataset文件夹，
    def initialize(self, parser):
        parser = BaseOptionsApp.initialize(self, parser)
        ...
        parser.set_defaults(dataset_mode='font')
        ...
        # parser.add_argument('--beta1', type=float, default=0.5, help='momentum term of adam')
        parser.add_argument('--lr_adamw', type=float, default=0.004, help='initial learning rate for adam')
